...
class ApplicantTest < Minitest::Test
  ...
  describe 'Applicant' do
    before do
      @mla = MlaActiveDutyStatus::Applicant.new(last_name: 'James', ssn: '123456789', date_of_birth: '1950-02-02')
    end
    ...
    describe 'last_name validations' do
      def test_invalid_last_name
        mla = MlaActiveDutyStatus::Applicant.new(last_name: '', ssn: '123456789', date_of_birth: '1950-02-02')
    ...
    describe 'date_of_birth validations' do
      def test_invalid_dob
        mla = MlaActiveDutyStatus::Applicant.new(last_name: 'James', ssn: '123456789', date_of_birth: '1850-02-02')
        assert_equal false, mla.valid?
